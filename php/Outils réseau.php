...
<p>
<input type="button" onclick="window.location.href = 'Tester une ip.php';" class="w3-border w3-button w3-text-white" value="Tester une ip"/>
</p>
<p>
<input type="button" onclick="window.location.href = 'Tester un port tcp.php';" class="w3-border w3-button w3-text-white" value="Tester un port tcp"/>
</p>
<p>
